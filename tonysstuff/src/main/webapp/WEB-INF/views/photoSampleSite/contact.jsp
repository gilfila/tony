...
<title>Contact Us | Emilie - Photography Portfolio HTML Template</title>
...
<body class="pageScroll">
	...
	<div class="content-wrapper">
        ...
        <div class="featured-area map-area">
        ...
        <div class="container">
        	<div class="content-inner-wrap">
                ...
                <div class="page-title">
                	<h1 class="page-heading1 heading-center">Contact Us</h1>
                    <ul class="breadcrumb">
                ...
                <div class="row">
                	...
                	<div class="col-md-6">
                    	<div class="box contact-left-area animate-fadeIn">
                        
                        	<figure class="post-image">
                            	<img src="images/upload/contact-image.jpg" alt="contact us" />
                            </figure>
                            
                            <div data-height="35"></div>
                            
                            <p>Vestibulum tincidunt facilisis ultrices. Aliquam ullamcorper dolor et risus ultrices gravida. Maecenas a rutrum nunc. Integer aliquet magna non tellus volutpat quis pretium neque iaculis. Cras laoreet tellus a urna bibendum commodo iaculis ligula commodo. Aliquam dignissim viverra dolor sit amet condimentum. Aenean sollicitudin, justo eu pulvinar rutrum, felis lectus mattis purus, a auctor nunc metus.</p>
                    ...
                    <div class="col-md-6">
                    	<div class="box contact-right-area">
                        	
                            <!--Contact Info Start-->
                            <ul class="contact-info">
                            	<li class="contact-address">559 Lilac Lane Statesboro GA USA 30458.</li>
                                <li class="contact-phone">123 456 7890</li>
                                <li class="contact-email">contact@domain.com</li>
                            </ul>
                            <!--Contact Info End-->
                            
                            <div data-height="43"></div>
                            
                            <!--Send Message Input Start-->
                            <h3 class="page-heading3">Get in touch</h3>
                            
                            <form id="form_contact" class="submit-form contact-form">
                                ...
                                <div class="box text-input">
                                	<input id="mysubject" type="text" name="mysubject" required />
                                	<label>Subject</label>
                                	<span></span>
                                </div>
                                <div class="box text-input textarea">
                                	<textarea id="mymessage" name="mymessage" required></textarea>
