...
<!--Google Fonts-->
<link
	href='http://fonts.googleapis.com/css?family=Play:400,700%7CRoboto:500,400italic,700italic,300,700,500italic,300italic,400&amp;subset=latin,latin-ext'
	rel='stylesheet' type='text/css'>
...
<body class="pageScroll">
	...
	<header class="header-section">
		 ...
		 <!--Logo Start-->
            ...
            <ul class="menu topnav" id="myTopnav">
                ...
                <li class="active"><a href="#s2">Sessions</a>
                    <!--  <ul class="submenu">
                        <li><a href="#">Mini</a></li>
                        <li><a href="#">Family</a></li>
                        <li><a href="#">Baby</a></li>
                        <li><a href="#">LifeStype</a></li>
                        <li><a href="#">Pet</a></li>
                    </ul>-->
                </li>
                <li><a href="#Galleries">Portfolio</a>
                </li>
                <li class="icon">
	...
	<div class="content-wrapper">
		...
		<div class="slide-wrapper home-slide">
			...
			<ul class="slide-nav">
				<li><a class="slide-prev" href="prev"><i
						class="fa fa-angle-left"></i></a></li>
				<li><a class="slide-next" href="next"><i
		...
		<div class="about-us-panel">
			<div class="container">
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="box about-us-heading">
						<h2>Welcome to Gilfillan Photography, take a look around!</h2>
					</div>
				</div>
				<!--End-->
				...
				<div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
					<div class="box about-us-divider"></div>
				</div>
				<!--End-->
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="box about-us-description">
						<p>Colleen is a local photographer based out of Central IL</p>
					</div>
				</div>
				<!--End-->
				...
				<div class="featured-area-caption">
					<div class="container">
						<div class="box animate-fadeInDown">
							<h1>Aenean gravid</h1>
							<div class="featured-description">Sed fringilla egestas
								condimentum morbi urna</div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="about-us-panel">
			<div class="container">
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="box about-us-description">
						<p>Colleen is an all purpose photographer located in
							Washington Illinois. She is a patient photographer who is good
							with kids, and has a passion for photography.</p>
					</div>
				</div>
				<!--End-->
		...
		<div class="category-filter">
			<div class="container">
				<h2><a id="Galleries"></a>Galleries</h2>
				<ul>
					<li class="filter selected" data-category="cat-all">All
						Categories</li>
					<li class="filter" data-category="cat-one">Baby</li>
					<li class="filter" data-category="cat-two">Family</li>
					<li class="filter" data-category="cat-three">Life Style</li>
					<li class="filter" data-category="cat-four">Pet</li>
					<li class="filter" data-category="cat-five">Senior Pics</li>
				</ul>
			</div>
		</div>
		<!--Category Filter End-->
		...
		<div class="footer-section">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-8 col-md-offset-2">
							...
							<a id="Contact"></a>
								<p>Email: info@gilfillanphotography.com</p>
								<p>Phone: 309 635 4966</p>
							</div>
						</div>
						<!--End-->
						...
						<div class="col-md-8 col-md-offset-2">
							<ul class="footer-social animate-fadeIn">
								<li class="footer-facebook"><a href="https://www.facebook.com/pg/colleengilfillanphotography/" target="_blank"><i
										class="fa fa-facebook"></i></a></li>
								<li class="footer-instagram"><a href="https://www.instagram.com/colleengilfillanphotography/" target="_blank"><i
			...
			<div class="footer-bottom">
				...
				<!--Copyright Start-->
				<div class="container">
					Copyrights Â© 2017 <a href="#">Gilfillan Photography</a>. All Rights Reserved.
				</div>
				<!--End-->
